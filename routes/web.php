...
// save transaction details done from payment addon.
Route::post('/payment/save-transaction', 'SaveTransactionDetailsController@saveTransaction')->name('payment.save.transaction');

// how to videos & addons page
Route::get('/how-to-videos', function () {
	return view('how_to_videos.how_to_videos');
})->middleware('auth');

Route::get('/addons', function () {
	return view('addon.addon');
})->middleware(['auth', 'discover.packages']);
...
Route::group(['prefix' => 'service'], function () {
	...
	Route::post('add', ['as' => 'service/add/post', 'uses' => 'ServicesControler@store'])->middleware('can:service_add');
	...
	// Route for getting assignees for filter dropdown
	Route::get('get-assignees', ['as' => 'service/get-assignees', 'uses' => 'ServicesControler@getAssignees']);
...
Route::get('/quotation/get-product-list', 'QuotationController@quotationProductList');
...
Route::group(['prefix' => 'setting'], function () {
	//For upload package
	//Route::get('/setting/upload-package',  'DiscoverPackageController@uploadPackageForm')->middleware('auth');

	// Route::post('/setting/upload-package', 'DiscoverPackageController@discoverPackage')->middleware('auth');

	// For payment gateway
	Route::get('/payment-gateways/list', function () {
	...
	//customer onborading setting
	Route::get('customerOnboarding/list', function () {
		return view('customer_onboarding.list');
	});
	Route::post('customerOnboarding/store', 'GeneralController@loginSettingStore');
...
//Csv import menu
Route::group(['prefix' => 'csv_import'], function () {
	Route::get('/list', ['as' => 'listcsvimport', 'uses' => 'CsvImportController@index'])->middleware('can:csvimport_view');
	
});
//users csv import routes
Route::post('/users_upload','CsvImportController@uploadUsersCsv');
Route::get('/download_sample_csv','CsvImportController@downloadUserSampleCsv');
Route::post('/vehicle_upload','CsvImportController@uploadVehiclesCsv');
Route::get('/download_vehicle_sample_csv','CsvImportController@downloadVehicleSampleCsv');
Route::post('/products_upload','CsvImportController@uploadProductsCsv');
Route::get('/download_products_sample_csv','CsvImportController@downloadProductsSampleCsv');

//sms setting route
Route::get('/setting/sms_setting/list',function(){
	return view('sms_setting.sms_setting');
});

//License setting menu
Route::get('/setting/license_setting/list', 'LicenseSettingController@index')->middleware('can:license_view');
Route::group(['prefix' => 'license'], function () {
    Route::post('send-otp','LicenseSettingController@sendLicenseOtp')->name('license.setting.send-otp');
    Route::post('verify-otp','LicenseSettingController@verifyLicenseOtp')->name('license.setting.verify-otp');
});
...
Route::group(['prefix' => 'notes'], function () {
	...
	Route::get('/list', 'NotesController@list')->middleware('can:notes_view');
