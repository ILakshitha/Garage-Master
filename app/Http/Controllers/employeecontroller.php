			...
			$response = [
				...
				'data' => $data->map(function ($employee) {
					return [
						...
						'name' => '<a href="' . url('/employee/view/' . $employee->id) . '" class="serviceview">' . $employee->name . '</a>',
						'lastname' => '<a href="' . url('/employee/view/' . $employee->id) . '" class="serviceview">' . $employee->lastname. '</a>',
