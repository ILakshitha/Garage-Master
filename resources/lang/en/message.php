...
return [
	...
	"Package discovered and registered successfully." => "Package discovered and registered successfully.",
    "No valid packages found in the uploaded zip file." => "No valid packages found in the uploaded zip file.",
    "no package dir found." => "No package dir found.",
    "Addons" => "Addons",
    "How To Videos" => "How To Videos",
    "No.1 Garage Management System in 2025 | Mojoomla" => "No.1 Garage Management System in 2025 | Mojoomla",
    "FREE Garage Management System Demo - Mojoomla" => "*FREE* Garage Management System Demo - Mojoomla",
    "Vehicle Fitness Certificate in Garage Management System" => "Vehicle Fitness Certificate in Garage Management System",
    "Expert Tips for Garage Invoice Sharing on WhatsApp - Mojoomla" => "Expert Tips for Garage Invoice Sharing on WhatsApp - Mojoomla",
    "Garage Master Customer Journey - Hassle-Free Car Maintenance Experience" => "Garage Master Customer Journey - Hassle-Free Car Maintenance Experience",
    "Garage Master – Mobile App for Garage Master Software" => "Garage Master – Mobile App for Garage Master Software",
    ...
    "Paypal client Id Not found or wrong client id" => "Paypal client Id Not found or wrong client id",
    "Transaction was successful, but failed to save in DB." => "Transaction was successful, but failed to save in DB.",
	...
	"Select Module For Bulk Upload"=>"Select Module For Bulk Upload",
	"SELECT"=>"SELECT",
	"Vehicles imported successfully!"=>"Vehicles imported successfully!",
	"Import Vehicles from CSV"=>"Import Vehicles from CSV",
	"Admin"=>"Admin",
	"Garage Master Installation"=>"Garage Master Installation",
	"Garage Sms Package"=>"Garage Sms Package",
	"Garage Payment Package"=>"Garage Payment Package",
	"STRIPE"=>"STRIPE",
	"BRANCH"=>"BRANCH",
	"EMAIL"=>"EMAIL",
	"QUOTATION"=>"QUOTATION",
	...
	"Mobile OTP Login"=>"Mobile OTP Login",
	"Verify OTP"=>"Verify OTP",
	"Send OTP"=>"Send OTP",
	"Enter Mobile Number"=>"Enter Mobile Number",
	"Enter OTP"=>"Enter OTP",
	"Enable Mobile Login"=>"Enable Mobile Login",
	"Remember me"=>"Remember me",
	"Log In"=>"Log In",
	"Customer Onboarding"=>"Customer Onboarding",
	"CUSTOMER ONBOARDING SETTING"=>"CUSTOMER ONBOARDING SETTING",
	"Enable Customer Login"=>"Enable Customer Login",
	"Please Select Login Type"=>"Please Select Login Type",
	"Customer Onboarding Settings Updated Successfully"=>"Customer Onboarding Settings Updated Successfully",
	...
	"License Reset"=>"License Reset",
	"Enter Purchase key"=>"Enter Purchase key",
	"Service reminder notification for customers"=>"Service reminder notification for customers",
	"Before enabling mobile login, Please update your general setting first."=>"Before enabling mobile login, Please update your general setting first.",
	"License Information"=>"License Information",
	"Current Registered Domain"=>"Current Registered Domain",
	"Registration Email"=>"Registration Email",
	"OTP Verification"=>"OTP Verification",
	"An OTP has been sent to your email address. Please enter the 6-digit code below"=>"An OTP has been sent to your email address. Please enter the 6-digit code below",
	"OTP will expire in"=>"OTP will expire in",
	"Didn't receive the OTP?"=>"Didn't receive the OTP?",
	"License Reset Successful!"=>"License Reset Successful!",
	"Your license has been reset successfully. You can now register your application with a new domain."=>"Your license has been reset successfully. You can now register your application with a new domain.",
	"Next Steps"=>"Next Steps",
	"Restart your application"=>"Restart your application",
	"Enter your license key when prompted"=>"Enter your license key when prompted",
	"Register with your new domain"=>"Register with your new domain",
	"Enter your registered email"=>"Enter your registered email",
	"If you want to transfer your license to a new domain, please reset this license. This action will deactivate your current license on this domain and allow you to register a new domain."=>"If you want to transfer your license to a new domain, please reset this license. This action will deactivate your current license on this domain and allow you to register a new domain.",
	"Important"=>"Important",
];
// English en
