        ...
        <div class="page-title">
            <div class="nav_menu">
                <nav>
                    ...
                    <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/observation/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup">
                    ...
                    <div class="x_panel">
                        <form id="form_add" action="{{ url('/observation/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left observationAddForm">
                            ...
                            <div class="row parentClass_1 {{ $errors->has('checkpoint') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-3 col-lg-3 col-xl-3 col-xxl-3 col-sm-3 col-xs-3">
                                    <input id="author_email" placeholder="{{ trans('message.Enter Checkpoint Name') }}" name="checkpoint[]" type="text" class="form-control checkpoint checkpointsData" required="true" disabled="true" rowid="1">
            ...
            <div class="modal-body">
                <div class="row form-group">
                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                        <input id="cat" placeholder="{{ trans('message.Enter Checkpoint Category Name') }}" name="category" type="text" class="form-control model_input add_newcat" value="" required />
                    </div>
                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                        <button type="button" class="btn btn-success model_submit add_cat btn-sm mx-3 margin-right-0">{{ trans('message.Submit') }}</button>
                    </div>
                </div>
            ...
            $(add_button).click(function(e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    $(wrapper).append('<div class="row mt-3 parentClass_' + x +
                        ...
                        '<input class="form-control col-md-3 col-lg-3 col-xl-3 col-xxl-3 col-sm-3 col-xs-3 addcheckpoint checkpointsData checkpointsDataddmore" id="chek_pt" type="text" placeholder="{{ trans('message.Enter Checkpoint Name') }}" required="true" name="checkpoint[]" rowid="' +
                        x + '"/>' + 
