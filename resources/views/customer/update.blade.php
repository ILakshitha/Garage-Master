          ...
          <div class="row row-mb-0">
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback">
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 gender ps-0">
                <input type="radio" name="gender" value="0" <?php if ((int)$customer->gender === 0) {
                                                              echo 'checked';
                                                            } ?>> {{ trans('message.Male') }}

                <input type="radio" name="gender" value="1" <?php if ((int)$customer->gender === 1) {
                                                              echo 'checked';
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <select class="form-control select_branch form-select" name="branch">
                    ...
                    <option value="{{ $branchData->id }}" <?php if ($customer->branch_id == $branchData->id) {
                                                            echo 'selected';
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group has-feedback">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <select class="form-control city_of_state form-select" name="city">
                  ...
                  <option value="{!! $citys->id !!}" <?php if ($customer->city_id == $citys->id) {
                                                        echo 'selected';
                                                      } ?>>{!! $citys->name !!}</option>
                  @endforeach
                  @else
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <textarea class="form-control addressTextarea" id="address" name="address" maxlength="100">{{ $customer->address }}</textarea>
                        ...
                        <div class="row col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 form-group note-row">
                            ...
                            <hr>
                            @foreach ($customer->notes as $key => $note)
