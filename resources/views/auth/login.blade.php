            ...
            <div class="content-form-login-page-school-plugin md-form">
              ...
              @if($smsAddonExists && $isMobileLoginActive == 0)
                ...
                <div class="login-tabs">
                  ...
                  <button type="button" class="tab-button" onclick="switchTab('mobile')">
                    📱 Mobile Login
                  </button>
                </div>
              @endif
                ...
                <form class="form-horizontal" method="POST" action="{{ url('/login') }}">
                  ...
                  <p class="login-password">
                    ...
                    <input type="password" name="password" id="user_pass" autocomplete="new-password" class="input" value="" size="20">
                     <span class="password-toggle" onclick="togglePassword('user_pass', this)">
                ...
                <div id="mobile-tab" class="tab-content">
                  <div class="mobile-login-section">
                    ...
                    <div id="verify-otp-form" style="display: none;">
                      ...
                      <form method="POST" action="{{ route('login.otp.verify.submit') }}" onsubmit="handleVerifyOTP(event)">
                        @csrf
                        ...
                        <div style="text-align: center; margin-bottom: 15px;">
                          ...
                          <span class="resend-link disabled" id="resend-link" onclick="resendOTP()">
                            Resend OTP
                          </span>
                        </div>
                      ...
                      <p class="login-submit">
                        <button type="button" class="back-button" onclick="backToMobile()">
...
function togglePassword(inputId, toggleElement) {
  ...
  <script>
    ...
    function handleSendOTP(event) {
      ...
      // For demo purposes, if not actually submitting to server
      // Uncomment the following lines and comment out the Laravel form submission
      /*
      event.preventDefault();
      setTimeout(() => {
        showOTPForm();
