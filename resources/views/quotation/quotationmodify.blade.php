                ...
                <form method="post" action="{!! url('/quotation/add_modify_quotation') !!}" class="addJobcardForm">
                    ...
                    <div class="row row-mb-0">
                        <div class="row col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-sm-7 col-xs-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 garrageadd mt-4" valign="top">
                        ...
                        <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-5 col-xs-5 pt-md-4">
                            <div class="row pt-md-4 row-mb-0">
                    ...
                    <div class="row row-mb-0">
                        ...
                        <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                            ...
                            <div class="row row-mb-0">
                                <label class="control-label jobcardmargintop col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                    {{ trans('message.MOT Testing Charges') }} (<?php echo getCurrencySymbols(); ?>)</label>
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    <input type="text" id="MOT" name="MotCharge" value="{{ $services->mot_charge }}" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2"></div>
                            @endif
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                ...
                                <div class="row row-mb-0">
                                    ...
                                    <!-- end observation select drop-down -->
                                    ...
                                    <table class="table table-bordered main_data_points" id="main_data_points" align="center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="fw-bold" style="width:12%;">{{ trans('message.Observation Point') }}</th>
                                                <th class="fw-bold" style="width:12%;">{{ trans('message.Service Charge') }}</th>
                                                <th class="fw-bold" style="width:11%;">{{ trans('message.Select Product') }}</th>
                                                <th class="fw-bold" style="width:9%;">{{ trans('message.Price') }}
                                                    (<?php echo getCurrencySymbols(); ?>)
                                                </th>
                                                <th class="fw-bold" style="width:8%;">{{ trans('message.Qty') }}</th>
                                                <th class="fw-bold" style="width:10%;">{{ trans('message.Total') }}
                                                    (<?php echo getCurrencySymbols(); ?>)</th>
                                                <th class="fw-bold" style="width:9%;">{{ trans('message.Chargeable') }}</th>
                                                <th class="fw-bold" style="width:10%;">{{ trans('message.Comments') }}</th>
                                                <th class="fw-bold" style="width:7%;">{{ trans('message.Action') }}</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody id="tbd">
                                            ...
                                            <?php foreach ($data as $datas) {   ?>
                                                <tr class="obs_point_data" id="<?php echo 'row_id_delete_' . $i; ?>">
                                                    ...
                                                    <td>
                                                         <select name="product2[product_id][]" class="form-control product_ids product1s_{{ $i }} searchable-single form-select" url="{{ url('/jobcard/getprice') }}" row_did="{{ $i }}" id="product1s_{{ $i }}" qtyappend="" required>
                                                    ...
                                                    <td>
                                                        @if (!empty($products))
                                                        <input type="text" name="product2[price][]" value="<?php if (!empty($datas)) {
                                                                                                                echo $datas->price;
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-bs-toggle="collapse" href="#collapse1-{{ $checkoout->id }}" class="ob_plus ob_plus{{ $checkoout->id }}"><i class="fa fa-plus"></i>
...
<!-- <script>
        ...
        selectedOptions.forEach((option) => {
            ...
            const newRow = `
                <tr id="row-${categoryId}" class="obs_point_data">
                    ...
                    <td>
                        <select name="product2[product_id][]" class="form-control product_ids" data-row-index="${rowIndex}">
    ...
    $(document).on('click', '.delete-row', function () {
        ...
        // Deselect the corresponding option in Select2
