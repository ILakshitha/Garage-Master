...
@media (max-width: 912px) {
    select.form-control.select_vehicaltype, select.form-control.select_vehicalbrand,select.form-control.model_addname,select.form-control.select_fueltype  {
        width: 275px;
    }
    select#vhi{
        width : 300px;
                        ...
                        <form id="QuotationAdd-Form" method="post" action="{{ url('/quotation/store') }}" enctype="multipart/form-data" class="form-horizontal upperform serviceAddForm" border="10">
                            ...
                            <div class="row row-mb-0">
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 padding-right-7">
                                        <select name="Customername" id="cust_id" class="form-control select_vhi select_customer_auto_search form-select" cus_url="{!! url('service/get_vehi_name') !!}" required>
                            ...
                            <div class="row row-mb-0">
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                        <select name="vehicalname" class="form-control modelnameappend form-select w-115" id="vhi" required>
                                            <option value="">{{ trans('message.Select vehicle Name') }}</option>
                                            <!-- Option comes from Controller -->
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2 addremove">
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#vehiclemymodel" class="btn btn-outline-secondary vehiclemodel fl margin-left-0">{{ trans('+') }}</button>
                                    </div>
                                </div>
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                                        <input type='text' class="form-control datepicker" name="date" autocomplete="off" id='p_date' placeholder="yyyy-mm-dd hh:mm:ss" value="{{ old('date', now()->format('Y-m-d H:i:s')) }}" onkeypress="return false;" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                        <label class="radio-inline"><input type="radio" name="service_type" id="free" value="free" required class="margin-left-10">{{ trans('message.Free') }}</label>
                                        <label class="radio-inline"><input type="radio" name="service_type" checked id="paid" value="paid" required class="margin-left-10">{{ trans('message.Paid') }}</label>
                                    </div>
                                </div>
                                ...
                                <div id="dvCharge" class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback 
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                        <input type="text" id="charge_required" name="charge" class="form-control fixServiceCharge" placeholder="{{ trans('message.Enter Service Charge') }}" value="{{ old('charge') }}" maxlength="8">
                        ...
                        <form id="formcustomer" method="POST" name="formcustomer" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group has-feedback {{ $errors->has('company_name') ? ' has-error' : '' }} ">
                                    <label class="control-label company-name col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 p-0" for="display-name">{{ trans('message.Company Name') }}</label>
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.addvehicleservice', function(event) {
            ...
            $.ajax({
                type: 'GET',
                url: '{!! url('/vehicle/check-number-plate-unique') !!}',
                data: {numberPlate: call_var_vehicleadd.np},
                success: function(response) {
                    if(response.unique == false) {
                        var msg = "Number Plate you entered is already registered.";
                        $('#npe').html(msg);
