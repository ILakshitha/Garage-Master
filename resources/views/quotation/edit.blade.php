                    ...
                    <form id="QuotationEdit-Form" method="post" action="update/{{ $service->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    <label class="radio-inline">
                                        <input type="radio" name="service_type" id="free" value="free" required class="margin-left-10" <?php if ($service->service_type == 'free') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>{{ trans('message.Free') }}</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="service_type" id="paid" value="paid" required class="margin-left-10" <?php if ($service->service_type == 'paid') {
                                                                                                                    echo 'checked';
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-1 mx-0 pe-3">
                                <button type="submit" class="btn btn-success updateQuotationButton">{{ trans('message.Save and continue') }}</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('body').on('keyup', '.washbay_charge_textbox', function() {
            ...
            if (washbayVal != "") {
                if (!washbayVal.match(/^[1-9][0-9]*$/). length) {
                    $(this).val("");
