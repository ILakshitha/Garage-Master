...
@media (max-width: 912px) {
    select.form-control.select_vehicalbrand, select.form-control.select_fueltype, select.form-control.select_vehicaltype,select.form-control.model_addname {
        width: 301px;
    }
    ...
    <div class="page-title">
        <div class="nav_menu">
            <nav>
                ...
                <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/vehicle/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup">
                    ...
                    <form id="vehicleAdd-Form" action="{{ url('/vehicle/store') }}" method="post" enctype="multipart/form-data" class="form-horizontal upperform vehicleAddForm">
                        ...
                        <div class="row row-mb-0">
                            <div class="row row-mb-0">
                                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                    <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="first-name">{{ trans('message.Vehicle For')}}<label class="color-danger"></label></label>
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 addremove">
                                    <button type="button" class="btn btn-outline-secondary btn-sm fl" data-bs-target="#responsive-modal" data-bs-toggle="modal">{{ trans('message.Add/Remove') }}</button>
                                </div>
                        ...
                        <div class="row row-mb-0">
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 addremove">
                                    <button type="button" class="btn btn-outline-secondary btn-sm fl" data-bs-target="#responsive-modal-brand " data-bs-toggle="modal">{{ trans('message.Add/Remove') }}</button>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6" id="customer-field">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    <select class="form-control select_customer form-select" id="customer_select_box1" name="customer">
                        ...
                        <div class="row row-mb-0">
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 addremove">
                                    <button type="button" class="btn btn-outline-secondary btn-sm fl" data-bs-target="#responsive-modal-fuel" data-bs-toggle="modal">{{ trans('message.Add/Remove') }}</button>
                                </div>
                            </div>
                        ...
                        <div class="row row-mb-0">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                    <div class="select-wrapper">
                                        <select class="form-control model_addname form-select" name="modelname" required>
                                            ...
                                            <option value="{{ $model_names->id }}">{{ $model_names->model_name }}
                                            </option>
                                            @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 addremove">
                                    <button type="button" class="btn btn-outline-secondary btn-sm fl" data-bs-target="#responsive-modal-vehi-model" data-bs-toggle="modal">{{ trans('message.Add/Remove') }}</button>
                                </div>
                            </div>
                        ...
                        <div class="row row-mb-0">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group">
                                ...
                                <div class="table-responsive mt-3 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 table-bordered ms-0">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group ms-1">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 text-end mb-3">
                                    <button type="button" data-bs-target="#responsive-modal-color" data-bs-toggle="modal" class="btn btn-outline-secondary btn-sm newaddvehicledescription mt-1 fl margin-left-0">{{ trans('message.Add/Remove') }}</button><br>
                                </div>
                                        ...
                                        <table class="table vehical_type_class">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 data_popup">
                                                    <button type="button" class="btn btn-success vehicaltypeadd model_submit margin-right-15" id="vehicleTypeSubmit" url="{!! url('/vehicle/vehicle_type_add') !!}">{{ trans('message.Submit') }}</button>
                                                </div>
                                            </div>
                                            <tbody>
                                                @if (!empty($vehical_type))
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-4 form-group data_popup">
                                            <button type="button" class="btn btn-success model_submit fueltypeadd fl margin-left-0" fuelurl="{!! url('/vehicle/vehicle_fuel_add') !!}">{{ trans('message.Submit') }}</button>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-4 form-group data_popup">
                                            <button type="button" class="btn btn-success model_submit vehi_model_add margin-right-15" modelurl="{!! url('/vehicle/vehicle_model_add') !!}">{{ trans('message.Submit') }}</button>
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var msg6 = "{{ trans('message.Submitted Successfully') }}";
        ...
        $('.select_vehicaltype').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if ($.trim(response) === '') {
                       $('.select_vehicalbrand').html('<option value="">Please Add Brand</option>');
                       // $('.select_vehicalbrand').prop('disabled', true);
                    } else {
        ...
        $('.select_vehicalbrand').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) { 
                    if ($.trim(response) === '') {
                         $('.model_addname').html('<option value="">Please Add Model</option>');
                       // $('.select_vehicalbrand').prop('disabled', true);
                    } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == '01') {
                            ...
                            $('.color').append('<option selected value=' + data + ' style="background-color:' + c_code + ';color: #ffffff;">'+ c_name +
                                '</option>'); 
