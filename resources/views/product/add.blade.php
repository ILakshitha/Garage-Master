      ...
      <nav>
        <div class="nav toggle">
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup"><a href="{!! url('/product/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="mb-1 back-arrow"></i><span class="titleup">
                {{ trans('message.Add Product') }}</span></a>
        </div>
          ...
          <form id="productAdd-Form" method="post" action="{{ url('/product/store') }}" enctype="multipart/form-data" class="form-horizontal upperform productAddForm">
            ...
            <div class="row row-mb-0">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="text" id="p_no" name="p_no" class="form-control" value="{{ $code }}" placeholder="{{ trans('message.Enter Product No') }}" readonly>
                </div>
              </div>
            ...
            <div class="row row-mb-0">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="name" name="name" class="form-control" placeholder="{{ trans('message.Enter Product Name') }}" value="{{ old('name') }}" maxlength="30" required>
                </div>
              </div>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 {{ $errors->has('price') ? ' has-error' : '' }} my-form-group">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="price" name="price" class="form-control" placeholder="{{ trans('message.Enter Product Price') }}" value="{{ old('price') }}" maxlength="10" required>
                  @if ($errors->has('price'))
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="sup_id">{{ trans('message.Supplier') }} <label class="color-danger">*</label></label>
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <select id="pro_sup_id" name="sup_id" class="form-control select_supplier_auto_search supplierDataFill form-select">
                    <option value="">{{ trans('message.-- Select Supplier --') }}</option>
                    @if (!empty($supplier))
                    @foreach ($supplier as $suppliers)
                    <option value="{{ $suppliers->id }}">{{$suppliers->name}} {{$suppliers->lastname}} - {{ $suppliers->company_name }}
                    </option>
                    @endforeach
                    @endif
                  </select>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="warranty" name="warranty" class="form-control" placeholder="{{ trans('message.Enter Product Warranty') }}" value="{{ old('warranty') }}" maxlength="20">
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row row-mb-0">
              ...
              <div class="row form-group col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 error_customfield_main_div_{{ $myCounts }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="{{ $tbl_custom_field->type }}" name="custom[{{ $tbl_custom_field->id }}]" placeholder="{{ trans('message.Enter') }} {{ $tbl_custom_field->label }}" maxlength="30" class="form-control textDate_{{ $tbl_custom_field->id }} textdate_simple_class common_value_is_{{ $myCounts }} common_simple_class" isRequire="{{ $required }}" fieldNameIs="{{ $tbl_custom_field->label }}" rows_id="{{ $myCounts }}" {{ $required }}>
                  ...
                  <form class="form-horizontal" action="" method="">
                    <div class="row">
                      <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 form-group data_popup">
                        ...
                        <input type="text" class="form-control model_input product_type" name="product_type" placeholder="{{ trans('message.Enter Manufacturer Name') }}" maxlength="30" />
                      </div>
                    ...
                    <table class="table producttype" align="center">
                      <tbody>
                        @foreach ($product as $products)
                        <tr class="del-{{ $products->id }} data_of_type row mx-1">
                          <td class="text-start col-6">{{ $products->type }}</td>
                          <td class="text-end col-6">
                            <button type="button" productid="{{ $products->id }}" deleteproduct="{!! url('prodcttypedelete') !!}" class="btn btn-danger text-white border-0 deleteproducted"><i class="fa fa-trash" aria-hidden="true"></i></button>
                          </td>
                        </tr>
