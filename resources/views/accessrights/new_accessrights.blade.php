                      ...
                      <div class="table-responsive">
                        <table id="supplier" class="table jambo_table table-responsive">
                          ...
                          <tbody>
                            ...
                            <!-- Vehicle Brand Access Rights End -->

                            <!-- Vehicle Model Access Rights Start -->
                            <tr>
                              <td>{{ trans('message.Vehicle Model') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="vehiclemodel" name="vehiclemodel[]" value="vehiclemodel_view" @if (!empty($regex->vehiclemodel_view)) @if ($regex->vehiclemodel_view == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="vehiclemodel_{{ $i }}" name="vehiclemodel[]" value="vehiclemodel_add" @if (!empty($regex->vehiclemodel_add)) @if ($regex->vehiclemodel_add == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="vehiclemodel_{{ $i }}" name="vehiclemodel[]" value="vehiclemodel_edit" @if (!empty($regex->vehiclemodel_edit)) @if ($regex->vehiclemodel_edit == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>
                                <input type="checkbox" class="vehiclemodel_{{ $i }}" name="vehiclemodel[]" value="vehiclemodel_delete" @if (!empty($regex->vehiclemodel_delete)) @if ($regex->vehiclemodel_delete == true) {{ 'checked' }} @endif
                                @endif
                                >
                              </td>
                              <td>-</td>
                            </tr>
                            <!-- Vehicle Model Access Rights End -->
                            ...
                            <tr>
                              ...
                              @if ($get_right->role_name == 'Employee' ||  $get_right->role_name == 'Accountant')
                              <!-- <td>
                                <input type="checkbox" class="quotation_{{ $i }}" name="quotation[]" value="quotation_owndata" @if ($get_right->role_name == 'Customer') checked disabled @endif @if (!empty($regex->quotation_owndata)) @if ($regex->quotation_owndata == true) {{ 'checked' }} @endif  
                                @endif
                                >  $get_right->role_name == 'Customer' ||
                              </td> -->
                              <td>
                              ...
                              @elseif($get_right->role_name == 'Customer')
                              <td>
                                <input type="checkbox" class="quotation_{{ $i }}" name="quotation[]" value="quotation_owndata" checked disabled>
                              </td>
                              @else
                              <td>-</td>
                              @endif
                            ...
                            <!-- Branch Setting Module Access Rights End -->
                             <!-- Notes Module Access Rights Start -->
                            <!-- <tr>
                              <td>{{ trans('message.Notes') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="notes" name="notes[]" value="notes" @if (!empty($regex->notes)) @if ($regex->notes == true) {{ 'checked' }} @endif
                                @endif
                                checked>
                              </td>
                              <td>-</td>
                            ...
                            <!-- Notes Module Access Rights End -->
                            <!-- Addon Module Access Rights start -->
                             <tr>
                              <td>{{ trans('message.Addons') }}</td>
                              <td class="">-
                                <!-- <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="addons" name="addons[]" value="addons" @if (!empty($regex->addons)) @if ($regex->addons == true) {{ 'checked' }} @endif
                                @endif
                                > -->
                              </td>
                              <td>-</td>
                            ...
                            <!-- Addon Module Access Rights end -->
                            <!-- How to video Module Access Rights start -->
                             <tr>
                              <td>{{ trans('message.How To Videos') }}</td>
                              <td class="">
                                <input type="checkbox" data-row="{{ $i }}" class="main_access" data-for="howtovideo" name="howtovideo[]" value="howtovideo" @if (!empty($regex->howtovideo)) @if ($regex->howtovideo == true) {{ 'checked' }} @endif
                                @endif
                                checked>
                              </td>
                              <td>-</td>
