            ...
            <div class="nav_menu">
                <nav>
                    <div class="nav toggle">
                        <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup me-0"><a href="{!! url('/accountant/list') !!}"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"> {{ $accountant->name . ' ' . $accountant->lastname }}</span></a>
                    </div>
