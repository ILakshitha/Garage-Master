      ...
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup">{{ trans('message.Branch Admin') }}
              @can('branchAdmin_add')
              <a href="{!! url('/branchadmin/add') !!}" id="" class="addbotton">
        ...
        <table id="supplier" class="table jambo_table" style="width:100%">
          ...
          <tbody>
            ...
            @endcan
              ...
              <td><a href="{!! url('/branchadmin/list/' . $branchadmin->id) !!}">{{ $branchadmin->name }}</a>
              ...
              <td>
                <div class="dropdown_toggle">
                  ...
                  <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                    ...
                    <li><a class="dropdown-item deletedatas" url="{!! url('/branchadmin/list/delete/' . $branchadmin->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                    @endcan
                  </ul>
                </div>
              </td>
