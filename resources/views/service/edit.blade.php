    ...
    selectedFiles.forEach((file, index) => {
        ...
        reader.onload = function(e) {
            previewItem.innerHTML = `
                <img src="${e.target.result}" alt="${file.name}" class="new-preview-image">
...
function setupDropZone() {
    const dropZone = document.getElementById("new-image-preview-container");
...
//                 // Optionally refresh the page or update vehicle dropdown
//                 location.reload();
//             }
//         },
            ...
            <div class="x_panel editServiceDescription mb-0">
                <div class="x_content">
                    ...
                    <form id="ServiceEdit-Form" method="post" action="update/{{ $service->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
                        ...
                        <div class="row row-mb-0">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="row">
                                    <label class="control-label col-md-4 col-sm-4"><strong>{{ trans('Current Owner') }}:</strong></label>
                                    <div class="col-md-8 col-sm-8">
                                        <span class="">{{ getCustomerName($service->customer_id) ?: trans('No Customer Assigned') }}</span>
                                    </div>
                                </div>
                            </div> -->
                        </div>
                        
                        <!-- Display Current Customer and Vehicle Info -->
                        <div class="row row-mb-0  p-2 mb-3" style="border-left: 4px ;">
                            
                            <!-- <div class="col-md-6">
                                <div class="row">
                                    <label class="control-label col-md-4 col-sm-4"><strong>{{ trans('Vehicle Number') }}:</strong></label>
                                    <div class="col-md-8 col-sm-8">
                                        <span class="text-success">{{ getVehicleNumberPlate($service->vehicle_id) ?: trans('No Vehicle Assigned') }}</span>
                                    </div>
                                </div>
                            </div> -->
                        </div>
                ...
                <input type="radio" name="service_type" id="free" value="free" class="free_service" required>{{ trans('message.Free') }}</label> -->
                            ...
                            <div id="dvCharge" class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('Charge') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    <input type="text" id="charge_required" name="charge" class="form-control fixServiceCharge" placeholder="{{ trans('message.Enter Service Charge') }}" value="{{ $service->charge }}" maxlength="8">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-mb-0">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    <input type="text" class="form-control mb-2" name="receiver_name" id="receiver_name" maxlength="100" value="{{ $receiver_name }}">
                                </div>
                            </div>
                        ...
                        <div class="row row-mb-0" >
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 mt-1">
                                ...
                                <div class="form-group col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    <input type="file" name="image[]" class="form-control imageclass" data-max-file-size="5M" id="images" onchange="preview_images();" multiple accept="image/*">

                                    <div class="row mt-2 mx-0" id="image_preview">
                                        @if (!empty($images1))
                                        @foreach ($images1 as $images2)
                                        <div class="col-md-4 col-sm-4 col-xs-12 removeimage image-preview-container" id="image_remove_<?php echo $images2->id; ?>" style="position:relative;">
                                            <img src="{{ url('public/service/' . $images2->image) }}" width="100px" height="60px">
                                            <button type="button" class="delete-icon delete_image" data-imageid="{{ $images2->id }}" imgaeid="{{ $images2->id }}" delete_image="{!! url('service/delete/getImages') !!}" style="position:absolute;top:2px;right:2px;background:rgba(0,0,0,0.7);border:none;border-radius:50%;width:25px;height:25px;cursor:pointer;display:none;">
                                    ...
                                    <div id="new-image-preview-container" class="mt-3 d-flex flex-wrap gap-2">
                ...
                <div class="row col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 mt-3">
                    ...
                    <div class="col-md-10 col-lg-10 col-xl-10 col-xxl-10 col-sm-10 col-xs-10">
                        <textarea id="notepad_edit" name="notepad" class="form-control" placeholder="{{ trans('message.Enter notes...') }}">{{ $service->notepad ?? '' }}</textarea>
                    </div>
                </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Stop event bubbling to prevent any parent element clicks
        e.stopPropagation();
        e.preventDefault();
