                    ...
                    <div class="row">
                        <div class="col-xl-10 col-md-9 col-sm-10">
                            <div class="user_profile_header_left">
                                ...
                                @else
                                    <img class="user_view_profile_image" src="{{ URL::asset('public/img/default-user.png') }}">
                                @endif
                                    ...
                                    <div class="view_top1">
                                        <div class="col-xl-12 col-md-12 col-sm-12">
                                            <label class="nav_text h5 user-name fh5">
                                                {{ $customer ? ($customer->name . ' ' . ($customer->lastname ?? '')) : 'No Customer Assigned' }}&nbsp;
                                            </label>
                                            @can('customer_edit')
                                        ...
                                        <div class="col-xl-12 col-md-12 col-sm-12 nav_text mt-2">
                                            <div class="d-lg-inline">
                                                ...
                                                {{ $customer ? $customer->mobile_no : 'N/A' }}
                                            </div>
                                            <div class="d-lg-inline">
                                        ...
                                        <div class="col-xl-12 col-md-12 col-sm-12 heading_view mt-3" style="width: 90%;">
                                            ...
                                            <lable class="">
                                                {{ $customer ? $customer->address : 'No Address' }}
                                                @if($customer)
                            ...
                            <div class="guardian_div pb-0">
                                <div class="center-container mb-3">
                                    <section id="selected-image" class="zoom-container">
                                        ...
                                        @else
                                            <img src="{{ URL::asset('public/img/no-image.png') }}" alt="No Image" height="200px" class="center-image" id="zoomed-image">
                                        @endif
                                    </section>
                                </div>
                                <div class="scroll-image">
                                    @if(!empty($available1))
                                        ...
                                        <!-- Download button -->
                                        <a href="{{ $imageURL }}" download class="btn btn-sm btn-primary ms-2" style="margin-bottom:5px;">
                                            Download
                                        </a>
                                        @endforeach
                                    @else
                                        <p>No images uploaded for this service.</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                            <div class="col-xl-6 col-md-6 col-sm-6">
                                <div class="guardian_div mb-2 pb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                            <label class=""> {{ trans('Details') }} :</label>
                                            <label class="fw-bold">
                                                {{ $service->detail ?? trans('message.Not Added') }}
                                            </label>
                                        </div>
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('KMs Run') }} :</label>
                                        <label class="fw-bold">
                                            {{ $service->kms_run ?? trans('message.Not Added') }}
                                        </label>
                                    </div>
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('message.Wash Bay') }} :</label>
                                        <label class="fw-bold">
                                            @if($washbay_data && $washbay_data->price > 0)
                                                {{ trans('message.Yes') }}
                                            @else
                                                {{ trans('message.No') }}
                                            @endif
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('Washbay Charge') }} :</label>
                                        <label class="fw-bold">
                                            @if($washbay_data && $washbay_data->price > 0)
                                                {{ getCurrencySymbols() }}{{ number_format((float) $washbay_data->price, 2) }}
                                            @else
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('message.MOT Test') }} :</label>
                                        <label class="fw-bold">
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('MOT Test Charge') }} :</label>
                                        <label class="fw-bold">
                                            @if($service->mot_status == 1 && $service->mot_charge > 0)
                                                {{ getCurrencySymbols() }}{{ number_format((float) $service->mot_charge, 2) }}
                                            @else
                                                {{ trans('message.Not Added') }}
                                            @endif
                                        </label>
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('message.Notes') }} :</label>
                                        <label class="fw-bold">
                                            @if($service->notes && $service->notes->count() > 0)
                                                {{ $service->notes->count() }} {{ trans('message.Note(s) Available') }}
                                            @else
                                                {{ trans('message.Not Added') }}
                                            @endif
                                        </label>
                                    ...
                                    <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                                        <label class=""> {{ trans('Notepad') }} :</label>
                                        <div class="fw-bold">
                                            @if($service->notepad && !empty(trim(strip_tags($service->notepad))))
                                                <div class="border p-2 mt-2" style="background-color: #f8f9fa; border-radius: 5px; font-size:11px;">
                                                    {!! $service->notepad !!}
                                                </div>
                                            @else
                                                <span>{{ trans('message.Not Added') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    <!-- For Custom Field -->
