      ...
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup">{{ trans('message.Custom Fields') }}
              @can('customfield_add')
              <a href="{!! url('setting/custom/add') !!}" id="" class="addbotton">
                ...
                <td>
                  <div class="dropdown_toggle">
                    ...
                    <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                      ...
                      <li><a class="dropdown-item deletecus" url="{!! url('/setting/custom/list/delete/' . $tbl_custom_field->id) !!}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                      @endcan
                    </ul>
                  </div>
                </td>
