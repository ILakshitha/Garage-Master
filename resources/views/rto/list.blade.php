      ...
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup">{{ trans('message.Compliances') }}
              @can('rto_add')
              <a href="{!! url('/rto/add') !!}" id=" " class="addbotton">
                ...
                <td>
                  <div class="dropdown_toggle">
                    ...
                    <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                      ...
                      <li><a class="dropdown-item deletedatas" url="{{ url('rto/list/delete/' . $rtos->id) }}" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</a></li>
                      @endcan
                    </ul>
                  </div>
                </td>
