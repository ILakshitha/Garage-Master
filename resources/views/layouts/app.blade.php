...
<head>
  ...
  <script src="{{ URL::asset('vendors/datatables.net-buttons/js/buttons.bootstrap.min.js') }}" defer="defer"></script>
  ...
  <script src="{{ URL::asset('vendors/datatables.net-scroller/js/scroller.dataTables.min.js') }}" defer="defer"></script>
  <script src="{!! URL::asset('public/vendor/pdfmake/js/vfs_fonts.min.js') !!}"></script>
  <script src="{!! URL::asset('public/vendor/pdfmake/js/pdfmake.min.js') !!}"></script>
  <script src="{!! URL::asset('public/vendor/pdfmake/js/Roboto.min.js') !!}"></script>
...
$baseUrl = url('/');
$currentUrl = ($_SERVER['REQUEST_SCHEME'] ?? 'http') . '://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
...
<body id="app-layout" class="nav-md <?php echo getValue(); ?>">
  ...
  <!-- Add multiple notes -->
  <script src="{{ URL::asset('public/js/custom/accessrights/notes.js') }}"></script>
