<style>
  @if(getLangCode()==='ar') .modal-header{margin-right: 14px !important;}
...
<div class="modal-body">
  <div class="x_content">
    <form method="post" id="form_add" action="{{ url('/invoice/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
      @csrf
      ...
      <div class="row">
        <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
          <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
            <input type="hidden" value="0" name="Invoice_type">
          </div>
        ...
        <div id="form_fields">
          <div class="row mt-3">
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 {{ getLangCode() !== 'ar' ? 'p-0 ps-2' : '' }} mt-2" for="cus_name">{{ trans('message.Invoice Number') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 {{ getLangCode() !== 'ar' ? 'p-0 ps-1' : '' }} mt-2" for="cus_name">{{ trans('message.Customer Name') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <input type="text" class="form-control" value="{{ getCustomerName($tbl_services->customer_id) }}" readonly="" id="customer_select_box1">
                <input type="hidden" name="Customer" value="{{ $tbl_services->customer_id }}">
              </div>
            </div>
          </div>

          <div class="row mt-3">
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6" id="job" style="">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 {{ getLangCode() !== 'ar' ? 'p-0' : '' }} mt-2" for="job_card">{{ trans('message.Jobcard Number') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <input type="text" name="Job_card" class="form-control" value="{{ $tbl_services->job_no }}" readonly>
              </div>
            </div>
            <input type="hidden" name="jobcard_no" class="servi_id" value="{{ $tbl_services->id }}"> 
          ...
          <div class="row mt-3">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                <input type="text" name="Date" autocomplete="off" id="date_of_birth" class="form-control invoiceDate datepicker" placeholder="yyyy-mm-dd" onkeypress="return false;" required="" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
              </div>
            </div>
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
          ...
          <div class="row mt-3">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 {{ getLangCode() !== 'ar' ? 'p-0 ps-2' : '' }} mt-2" for="cus_name">{{ trans('message.Grand Total') }} (<?php echo getCurrencySymbols(); ?>)
                <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <input type="text" id="grandtotal" name="grandtotal" class="form-control grandtotal" value="{{ $total_amount }}">
              </div>
            </div>
          ...
          <div class="row mt-3">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6  paymentTypeMainDiv">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 {{ getLangCode() !== 'ar' ? 'p-0 ps-2' : '' }} mt-2" for="cus_name">{{ trans('message.Payment Type') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <div class="select-wrapper">
                    ...
                    <tr>
                      <td class="bg-white text-dark">
                        <input type="checkbox" class="checkbox-inline check_tax sele_tax myCheckbox" name="Tax[]" value="<?php
                                                                                                                              echo $taxes->id; ?>" data-taxrate="{{ $taxes->tax }}" style="height:20px; width:20px; margin-right:5px; position: relative; top: 6px; margin-bottom: 12px">
                        <?php
        ...
        <input type="hidden" name="_token" value="7Ks0V9GgxbBhDfkWiSsf86tphGFtwZEBAkQpg0L0">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 mt-3">
          <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-1 mx-0">
              <button type="submit" class="btn btn-success submit submitButton submitinvoiceButton">{{ trans('message.SUBMIT') }}</button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    /*Disable jquery date - display only bootstrap icon date */
