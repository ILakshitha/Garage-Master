    ...
    <script language="javascript">
        function PrintElem(el) {
            if ("{{ $page_action }}" === "mobile_app") {
                ...
                var modalContentUrl = "{{ url('/sales_part/list/print') }}?serviceid={{ $sales->id }}&auto_id={{ $invioce->id }}";
...
<body>
    <div id="sales_print" class="col-md-12">
        ...
        <div class="mx-2">
            ...
            <div class="table-responsive w-100 pl-22 pr-15 ms-0">
    ...
    <div class="row me-4 pe-1">
        <div class="col-md-12 col-sm-12 col-xs-12 ms-lg-2">
            ...
            <div class="ps-0 modal-footer mpPrintPdfCloseButtonForSmallDevices">
                ...
                <a href="{{ url('invoice/salespartpdf/' . $invioce->id) }}?page_action=default" id="pdfDownloadBtn" class="prints tagAforPdfBtn"><button type="button" class="btn btn-outline-secondary btn-sm pdfButton mx-0" style="margin-left: 15px;"><img src="{{ URL('public/img/icons/PDF.png') }}" class="pdfButton"></button></a>
                <a href="" class="prints tagAforCloseBtn"><button type="button" data-dismiss="modal" class="btn btn-outline-secondary btn-sm closeButton margin-right-0 margin-left-40" style="margin-left: 5px;">{{ trans('message.Close') }}</button></a>
            </div>
