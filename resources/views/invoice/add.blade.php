            ...
            <div class="nav_menu">
                <nav>   
                    ...
                    <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a>
                        <a href="{!! url('/invoice/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup">
                                        ...
                                        <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                            <select name="Customer" class="form-control select_cus customer_name form-select" id="customer_select_box1" customer_url="{!! url('invoice/get_jobcard_no') !!}" vehicle_url="{!! url('invoice/get_vehicle') !!}" required>
                                                ...
                                                <option value="{{ $customers->customer_id }}">
                                                    <?php echo getCustomerName($customers->customer_id); //echo $customers->name.' '.$customers->lastname; 
                                                    ?></option>
                                                @endforeach
                                                @endif
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" id="tax" class="checkbox-inline check_tax sele_tax myCheckbox" name="Tax[]" value="<?php
                                                                                                                                                                echo $taxes->id; ?>" taxrate="{{ $taxes->tax }}" style="height:20px; width:20px; margin-right:5px; position: relative; top: 6px; margin-bottom: 12px;">
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('change', '.select_cus', function() {
            ...
            var selectJobcard = "{{ trans('message.Select Jobcard') }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if ($.trim(response) == '') {
                            ...
                            $('.job_number').html(
                                '<option value="">' + selectJobcard + '</option>');
                            return false;
                        }
                        $('.job_number').html('<option value="">' + selectJobcard + '</option>');
